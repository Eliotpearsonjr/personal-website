...
// Football Scouting Portfolio Subpage
// Eliot Pearson Jr
...
function CandyFrame({ children }: { children: React.ReactNode }) {
  return (
    <div
      ...
      style={{
        background:
          "repeating-linear-gradient(45deg, rgba(184, 207, 254, 0.8) 0 14px, rgba(255, 255, 255, 0.8) 14px 28px, rgb(150, 254, 251, 0.8) 28px 42px, rgb(255, 255, 255, 0.8) 42px 56px)",
      }}
    >
      {/* white inner panel */}
...
export default function CCLPlaybook() {
  ...
  const galleryItems = [
    {
        type: "image",
        src: "/Sprites/football/Football_Title_Page.png",
        alt: "RoboCEO Promo Material",
    },

    {
        type: "image",
        src: "/Sprites/football/Footballp_Approach_1.png",
        alt: "RoboCEO Driver Card Example",
    },

    {
        type: "image",
        src: "/Sprites/football/Footballp_Approach_2.png",
        alt: "RoboCEO Style Sheet",
    },

    {
        type: "image",
        src: "/Sprites/football/Footballp_Dowdell_1.png",
        alt: "LET'S GO RoboCEO April 2026 Informational Flyer",
    },

    {
        type: "image",
        src: "/Sprites/football/Footballp_Metayer_1.png",
        alt: "LET'S GO RoboCEO April 2026 Informational Flyer",
    },

    {
        type: "image",
        src: "/Sprites/football/Footballp_Metayer_2.png",
        alt: "LET'S GO RoboCEO April 2026 Informational Flyer",
    },
  ];
    ...
    <div className="bg-pink-100 dark:bg-stone-800 text-stone-700 dark:text-stone-100 my-10 p-4 border-2 border-rose-200 dark:border-stone-400 transition-opacity duration-300">
      ...
      <div className="flex flex-col">
        <Image
          ...
          src="/Sprites/football/Football_Portfolio_Banner.png"
          width={2000}
          height={400}
        ...
        <div className="text-stone-700 dark:text-white border-b-2 border-orange-900/10 dark:border-rose-300/10 pb-2 ml-7 mr-7 mb-2">
          <p className="text-4xl font-semibold">
            Scouting Report Portfolio Visualization
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center items-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 w-full lg:w-full mb-5">
            <p className="bg-pink-50 dark:bg-stone-900 text-stone-800 dark:text-stone-100 ml-5 mr-5 mb-5 p-4 rounded-2xl text-left border-2 border-rose-900/30 dark:border-rose-300/30 transition-opacity duration-300 text-2xl font-regular">
              This project was made per request of a client who wished to visualize their portfolio of
              scouting reports. <b> I DO NOT claim ownership of any of the metrics or written material, 
              which remians intellectual property of the client. </b> I used <b> Canva</b> to realize the client's vision.
            </p>
          </div>
        ...
        <div className="bg-pink-50 dark:bg-stone-900 text-stone-800 dark:text-stone-100 ml-5 mr-5 my-5 p-4 rounded-2xl text-left border-2 border-rose-900/30 dark:border-rose-300/30 transition-opacity duration-300 font-regular">
          <p className="text-2xl font-regular">
            I wanted to capture the aesthetic found in online media and television for football games. Clean lines,
            bold fonts, and dark colors that matched each teams colors helped to create contrast, highlighting
            player performance.
          </p>
        </div>
